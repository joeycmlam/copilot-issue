...
export const metadata: Metadata = {
  title: "Copilot Issue Console",
  description:
    "Create GitHub issues and assign them to the Copilot coding agent with custom agents, skills, and tools.",
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        <meta name="theme-color" content="#6c52e8" />
